...
def run(test, params, env):
    ...
    try:
        ...
        if not is_storage_migration:
            ...
            remote_file_list.append(libvirt_disk.create_remote_disk_by_first(vm,
                                                                             params))
        ...
        if migrate_again:
            ...
            if params.get('scp_list_client_again'):
                ...
                conn_obj_list.append(setup_tls_conn(params))
        ...
        migration_base.cleanup_conn_obj(conn_obj_list)
